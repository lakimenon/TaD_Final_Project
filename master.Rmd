...
dfm_2_stm <- as.data.frame(cbind(covid_corp$documents$texts, covid_corp$documents$date, covid_corp$documents$country))
dfm_2_stm
...
system.time(
news_stm <- stm(stm_dfm, K=0, init.type='Spectral', seed=12345, prevalence =~paperName + s(day),  data=stm_df))
